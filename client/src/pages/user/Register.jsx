    ...
    onSubmit: async (values, { resetForm }) => {
      ...
      try {
        ...
        if (response.payload.status === 200) {
          Cookies.set(
            "token",
            JSON.stringify(`Bearer ${response.payload?.data?.accessToken}`),
            {
              expires: 8 / 24,
            }
          );
          Cookies.set("user", JSON.stringify(response.payload?.data?.data), {
            expires: 8 / 24,
          });
      ...
      <section className="bg-white">
        <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
          <section className="relative flex h-32 items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
            <img
              alt=""
              src="https://scontent.fhan2-3.fna.fbcdn.net/v/t39.30808-6/447867343_1008930817468874_4195538983330316553_n.jpg?_nc_cat=108&ccb=1-7&_nc_sid=127cfc&_nc_ohc=RT4G_iStXIsQ7kNvgGdiICk&_nc_ht=scontent.fhan2-3.fna&oh=00_AYDZxLzk4KakV4HZOlaSu91tmMo2npTl5Lprf1PmtwPdqw&oe=6681D3C5"
            ...
            <div className="max-w-xl lg:max-w-3xl">
              ...
              >
                ...
                <div className="col-span-6">
                  ...
                  >
                    <img src={google} alt="" />
                    Đăng ký với bằng Google
                  </button>
                </div>

                <div className="col-span-6">
                  <p className="text-sm text-gray-500">
                    Bằng cách đăng ký vào tài khoản, bạn đồng ý với các điều
