      ...
      <section className="bg-white">
        <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
          <section className="relative flex h-32 items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
            <img
              alt=""
              src="https://scontent.fhan20-1.fna.fbcdn.net/v/t39.30808-6/448205572_1009456444082978_2502790683733349580_n.jpg?_nc_cat=103&ccb=1-7&_nc_sid=127cfc&_nc_ohc=G57AmxaqcUcQ7kNvgHSpRcB&_nc_ht=scontent.fhan20-1.fna&oh=00_AYB7bsb4GgzQ11ZeBQ1DvSA-DyicMRnv34WIduV-Z7paRA&oe=6681E6BC"
